...
**크리에이터 마켓플레이스** — 여행 고수의 코스를 사고, 내 코스를 만들어 팝니다.

<table>
<tr>
<td align="center"><img src="design/screens/05-market.png" width="200"><br/><b>⑤ 마켓플레이스</b><br/>코스 탐색·구매</td>
<td align="center"><img src="design/screens/06-paywall.png" width="200"><br/><b>⑥ 코스 구매</b><br/>1일차 미리보기·결제</td>
...
> 위 이미지는 실제 화면 구성을 반영한 디자인 목업입니다. 실기기 캡처는 빌드 후 교체할 수 있습니다.
...
6. **마켓플레이스** — 다른 사람이 만든 여행팩을 둘러보고 구매합니다. 유료 코스는 **1일차 미리보기** 후 결제하면 전체가 열립니다(구매 전 청약철회 안내 동의).
7. **내 여행팩 만들어 팔기** — MY → 내 여행팩 → 새 여행팩 만들기에서 지역·기간·가격·일자별 스팟을 구성해 **검수 요청** → 관리자 승인 후 마켓에 공개·판매됩니다.
...
- [x] **크리에이터 마켓플레이스(설계서 7장)** — 사용자가 코스를 만들어 공개·판매. 백엔드(작성·검수·이용권·구매·정산·페이월·**관리자 정산 대시보드**)+모바일(마켓·구매·작성기·내 코스/구매함) 완료, 테스트 84개. 결제는 mock(데모)·PortOne 어댑터(무료 즉시·유료는 키 연결 시). 출시 절차는 [docs/legal/출시_인허가_가이드.md](docs/legal/출시_인허가_가이드.md)
