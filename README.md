...
> 🏆 **2026 관광데이터 활용 공모전(웹·앱 개발 부문) 준비 중** — 트래블팩을 골격으로 **스톤마크(영토 점령 게임)**를 얹어, *완성형 코스를 따라 걷기만 해도 한국이 내 영토로 칠해지는* 통합 제품으로 본선(10월)을 노립니다. 문제정의(SCQA)·통합 전략·제안서 초안·실행계획은 [`docs/공모전기획/`](docs/공모전기획/) 참조.
