...
const MESSAGES = {
  ko: {
    ...
    'detail.nearby': '축제 주변 가볼 만한 곳',
    'detail.notFound': '축제 정보를 찾을 수 없어요.',
    'detail.backToList': '축제 목록으로',
    'detail.moreFestivals': '다른 축제 더 보기',
    'search.festivals': '축제',
    'filter.date': '시작일순',
    'filter.distance': '거리순',
  ...
  en: {
    ...
    'detail.nearby': 'Places nearby',
    'detail.notFound': 'Festival not found.',
    'detail.backToList': 'Back to festivals',
    'detail.moreFestivals': 'See more festivals',
  ...
  th: {
    ...
    'detail.nearby': 'สถานที่ใกล้เคียง',
    'detail.notFound': 'ไม่พบข้อมูลเทศกาล',
    'detail.backToList': 'กลับไปหน้าเทศกาล',
    'detail.moreFestivals': 'ดูเทศกาลอื่น',
  ...
  ja: {
    ...
    'detail.directions': '道順',
    'detail.nearby': '周辺の見どころ',
    'detail.notFound': '祭りの情報が見つかりません。',
    'detail.backToList': '祭り一覧へ',
    'detail.moreFestivals': '他の祭りを見る',
    'search.festivals': '祭り',
    'filter.date': '開始日順',
    'filter.distance': '近い順',
